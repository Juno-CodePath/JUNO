...
class ProfileViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func loadProfile() {
        ...
        self.occupationField.text = Global.shared.userProfile["jobTitle"] as? String
        self.companySchoolField.text = Global.shared.userProfile["companySchool"] as? String
        
        /*let file = Global.shared.userProfile["profilePhoto"] as? PFFileObject
        ...
        let imageFile = Global.shared.userProfile["profilePhoto"] as! PFFileObject
        ...
        /*query.findObjectsInBackground{(prof, error) in
            if prof != nil {
                ...
                //print(Global.shared.userProfile)
                self.nameLabel.text = Global.shared.userProfile["name"] as! String
                self.aboutMeField.text = Global.shared.userProfile["about"] as? String
                self.occupationField.text = Global.shared.userProfile["jobTitle"] as? String
                self.companySchoolField.text = Global.shared.userProfile["companySchool"] as? String
            } else {
        ...
        print(Global.shared.userProfile)
        //nameLabel.text = Global.shared.userProfile["name"]
    ...
    func saveChanges() {
        ...
        if (self.isPhotoChanged == true) {
            ...
            Global.shared.userProfile["profilePhoto"] = file
